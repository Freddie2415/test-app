...
class ThemeModeTransition extends StatefulWidget {
  const ThemeModeTransition({
  ...
  @override
  State<ThemeModeTransition> createState() => _ThemeModeTransitionState();
}

class _ThemeModeTransitionState extends State<ThemeModeTransition>
  ...
  @override
  void didUpdateWidget(ThemeModeTransition oldWidget) {
